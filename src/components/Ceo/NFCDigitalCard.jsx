...
// import companyLogo from "../../assets/HomeImg/logo_1.png";
import companyLogo from "../../assets/HomeImg/Spriex Infoway_LOGO A2.png";

export default function NFCDigitalCard() {
  ...
  return (
    <div className="min-h-screen outfit bg-white flex items-center justify-center md:px-4">
      ...
      <motion.div
        ...
        className="w-full lg:max-w-sm bg-white lg:rounded-[28px] lg:shadow-md overflow-hidden"
      >
